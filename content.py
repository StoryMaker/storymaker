...
def zip_content():
    ...
    if query_yes_no("zip IJF15?"):
        os.system("rm liger-content/assets/ijf15.main.3.obb; cd liger-content/assets ; zip -n .mp4 -r ../zips/ijf15.main.3.obb org.storymaker.app/ijf15")
        print "content generated at: liger-content/zips/ijf15.main.3.obb"
...
def adb_push_files():
    ...
    if query_yes_no("adb push ijf15.main.3.obb to device files/ folder?"):
        os.system("cd liger-content/zips ; adb push ijf15.main.3.obb /sdcard/Android/data/%s/files/ijf15.main.3.obb" % (packagename))
...
def build_zip_push_ijf15():
    ...
    os.system("cd liger-content ; python generate_content.py ; python generate_localized_content.py")
    os.system("rm liger-content/zips/ijf15.main.3.obb; cd liger-content/assets ; zip -n .mp4 -r ../zips/ijf15.main.3.obb org.storymaker.app/ijf15")
    print "content generated at: liger-content/zips/ijf15.main.3.obb"
    os.system("cd liger-content/zips ; adb push ijf15.main.3.obb /sdcard/Android/data/%s/files/ijf15.main.3.obb" % (packagename))
    os.system("sha256sum liger-content/zips/ijf15.main.3.obb")
    os.system("ls -l liger-content/zips/ijf15.main.3.obb")
    adb_push()
