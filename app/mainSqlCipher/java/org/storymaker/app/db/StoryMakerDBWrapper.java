 ...
 * </p>
 */
public abstract class StoryMakerDBWrapper extends SQLiteOpenHelper {

    private static final String TAG = "StoryMakerDBWrapper";

    protected Context mContext; // shame we have to duplicate this here
    private CacheWordHandler mHandler;

    public StoryMakerDBWrapper(CacheWordHandler cacheWord, Context context, String name,
