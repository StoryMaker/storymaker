		...
		.each(function () {
		    ...
		    if (role === "header" || role === "footer") {
				...
				!leftbtn) {
		            ...
		            backBtn = $("<a href='javascript:void(0);' class='ui-btn-right' data-" + $.mobile.ns + "rel='back' data-" + $.mobile.ns + "icon='arrow-r'>" + o.backBtnText + "</a>")
        ...
        $.widget("mobile.collapsible", $.mobile.widget, {
			...
			.find("a")
				...
				.buttonMarkup({
				    shadow: false,
				    corners: false,
				    iconpos: $el.jqmData("iconpos") || o.iconPos || "right",
				    icon: collapsedIcon,
				    mini: o.mini,
				    theme: o.theme
				});
                    ...
                    if (create || !item.hasClass("ui-li")) {
                        ...
                        if (a.length && !isDivider) {
                            ...
                            item.buttonMarkup({
                                ...
                                corners: false,
                                iconpos: "left",
                                icon: a.length > 1 || icon === false ? false : icon || "arrow-l",
                                theme: itemTheme
                            });
