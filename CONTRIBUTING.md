...
♥ [ListeningPost](#) and want to get involved?
...
Please read the following guidelines before you [report an issue](https://github.com/ListeningPost/storymaker/issues/):
...
**[File a bug report](https://github.com/ListeningPost/storymaker/issues/)**
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/storymaker.git`).

3. Add an `upstream` remote (`git remote add upstream
   https://github.com/ListeningPost/storymaker.git`).
